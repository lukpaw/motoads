angular.module("ui.bootstrap", ["ui.bootstrap.transition", "ui.bootstrap.collapse", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.bindHtml", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.position", "ui.bootstrap.datepicker", "ui.bootstrap.dropdownToggle", "ui.bootstrap.modal", "ui.bootstrap.pagination", "ui.bootstrap.tooltip", "ui.bootstrap.popover", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.timepicker", "ui.bootstrap.typeahead"]), angular.module("ui.bootstrap.transition", []).factory("$transition", ["$q", "$timeout", "$rootScope", function(e, t, n) {
    function a(e) {
      for (var t in e)
        if (void 0 !== r.style[t])
          return e[t]
    ...
    var i = function(a, r, o) {
      o = o || {};
      var l = e.defer(), c = i[o.animation ? "animationEndEventName" : "transitionEndEventName"], s = function() {
        n.$apply(function() {
    ...
    return{link: function(n, a, i) {
        ...
        var l, c = function(t) {
          ...
          o ? (o = !1, r || t(n, a, "auto")) : c({height: a[0].scrollHeight + "px"}).then(function() {
            r || t(n, a, "auto")
          }), r = !1
        }, u = function() {
          r = !0, o ? (o = !1, t(n, a, 0)) : (t(n, a, a[0].scrollHeight + "px"), c({height: "0"}))
        }
      }}
  ...
  return function(e, t, n) {
    ...
    var c = {day: i(t.dayFormat, a.dayFormat), month: i(t.monthFormat, a.monthFormat), year: i(t.yearFormat, a.yearFormat), dayHeader: i(t.dayHeaderFormat, a.dayHeaderFormat), dayTitle: i(t.dayTitleFormat, a.dayTitleFormat), monthTitle: i(t.monthTitleFormat, a.monthTitleFormat)}, s = i(t.startingDay, a.startingDay), u = i(t.yearRange, a.yearRange);
    this.minDate = a.minDate ? new Date(a.minDate) : null, this.maxDate = a.maxDate ? new Date(a.maxDate) : null, this.modes = [{name: "day", getVisibleDates: function(e, t) {
          var a = e.getFullYear(), i = e.getMonth(), u = new Date(a, i, 1), p = s - u.getDay(), d = p > 0 ? 7 - p : -p, f = new Date(u), m = 0;
          ...
          for (var b = 0; 7 > b; b++)
            h[b] = n(g[b].date, c.dayHeader);
          return{objects: g, title: n(e, c.dayTitle), labels: h}
          ...
          return{objects: a, title: n(e, c.monthTitle)}
        }, compare: function(e, t) {
        ...
        }, split: 5, step: {years: u}}], this.isDisabled = function(t, n) {
    ...
    return{restrict: "EA", require: "ngModel", link: function(o, l, c, s) {
        function u(e) {
          b ? b(o, !!e) : v.isOpen = !!e
        }
        function p(e) {
        ...
        var g = angular.isDefined(c.closeOnDateSelection) ? v.$eval(c.closeOnDateSelection) : r.closeOnDateSelection, h = c.datepickerPopup || r.dateFormat, v = o.$new();
  ...
  return{createNew: function() {
    ...
    var o, l, c = n.$new(!0), s = e.find("body").eq(0), u = a.createNew(), p = {};
        ...
        return u.open = function(t) {
          ...
          return p.then(function(e) {
            ...
            t.controller && (c.$scope = a, c.$modalInstance = u, angular.forEach(t.resolve, function(t, n) {
              c[n] = e[s++]
            }), r = o(t.controller, c)), l.open(u, {scope: a, deferred: i, content: e[0], backdrop: t.backdrop, keyboard: t.keyboard, windowClass: t.windowClass})
          }, function(e) {
            i.reject(e)
          }), p.then(function() {
            r.resolve(!0)
  ...
  return e
    ...
    return{restrict: "EA", scope: {page: "=", totalItems: "=", onSelectPage: " &", numPages: "="}, controller: "PaginationController", templateUrl: "template/pagination/pager.html", replace: !0, link: function(t, n, a, i) {
        function r(e, t, n, a, i) {
          return{number: e, text: t, disabled: n, previous: c && a, next: c && i}
        }
        var o = i.getAttributeValue(a.previousText, e.previousText, !0), l = i.getAttributeValue(a.nextText, e.nextText, !0), c = i.getAttributeValue(a.align, e.align);
  ...
  this.options = function(e) {
    ...
    angular.extend(n, e)
  }, this.$get = ["$window", "$compile", "$timeout", "$parse", "$document", "$position", "$interpolate", function(i, r, o, l, c, s, u) {
      return function(i, p, d) {
        function f(e) {
          var t = e || m.trigger || d, a = n[t] || t;
          return{show: t, hide: a}
        }
        var m = angular.extend({}, t, a), g = e(i), h = u.startSymbol(), v = u.endSymbol(), $ = "<" + g + "-popup " + 'title="' + h + "tt_title" + v + '" ' + 'content="' + h + "tt_content" + v + '" ' + 'placement="' + h + "tt_placement" + v + '" ' + 'animation="tt_animation()" ' + 'is-open="tt_isOpen"' + ">" + "</" + g + "-popup>";
        return{restrict: "EA", scope: !0, link: function(e, t, n) {
            ...
            function g() {
              ...
              if (e.tt_content) {
                switch (v && o.cancel(v), w.css( {
                    top: 0, left: 0, display: "block"}), k ? (y = y || c.find("body"), y.append(w)) : t.after(w), n = k ? s.offset(t) : s.position(t), a = w.prop("offsetWidth"), i = w.prop("offsetHeight"), e.tt_placement){case"right":
            ...
            var v, b, y, w = r($)(e), k = angular.isDefined(m.appendToBody) ? m.appendToBody : !1, D = f(void 0), x = !1;
  ...
  return{restrict: "EA", replace: !0, scope: {title: "@", content: "@", placement: "@", animation: "&", isOpen: "&"}, templateUrl: "template/popover/popover.html"}
    ...
    this.makeBar = function(e, t, n) {
      var o = angular.isObject(e) ? e.value : e || 0, l = angular.isObject(t) ? t.value : t || 0, c = angular.isObject(e) && angular.isDefined(e.type) ? e.type : r ? a(n || 0) : null;
      return{from: l, to: o, type: c, animate: i}
  ...
  return{restrict: "EA", replace: !0, controller: "ProgressBarController", scope: {value: "=percent", onFull: "&", onEmpty: "&"}, templateUrl: "template/progressbar/progress.html", link: function(e, t, n, a) {
    ...
    this.maxRange = angular.isDefined(t.max) ? e.$parent.$eval(t.max) : a.max, this.stateOn = angular.isDefined(t.stateOn) ? e.$parent.$eval(t.stateOn) : a.stateOn, this.stateOff = angular.isDefined(t.stateOff) ? e.$parent.$eval(t.stateOff) : a.stateOff, this.createDefaultRange = function(e) {
      for (var t = {stateOn: this.stateOn, stateOff: this.stateOff}, n = Array(e), a = 0; e > a; a++)
        n[a] = t;
      return n
  ...
  return{restrict: "EA", transclude: !0, replace: !0, require: "^tabset", scope: {}, controller: "TabsetController", templateUrl: "template/tabs/tabset.html", compile: function(e, t, n) {
    ...
    return{restrict: "EA", require: "?^ngModel", replace: !0, scope: {}, templateUrl: "template/timepicker/timepicker.html", link: function(a, i, r, o) {
        ...
        if (o) {
          ...
          var $ = i.find("input"), b = $.eq(0), y = $.eq(1), w = angular.isDefined(r.mousewheel) ? a.$eval(r.mousewheel) : n.mousewheel;
          if (w) {
            var k = function(e) {
    ...
    return{require: "ngModel", link: function(c, s, u, p) {
            ...
            if (e === p.$viewValue) {
              if (n.length > 0) {
                ...
                for (var a = 0; n.length > a; a++)
                  t[b.itemName] = n[a], w.matches.push({label: b.viewMapper(w, t), model: n[a]});
        ...
        p.$parsers.unshift(function(e) {
          ...
          var t, n, a = {};
          a[b.itemName] = n = w.matches[e].model, t = b.modelMapper(c, a), $(c, t), p.$setValidity("editable", !0), h(c, {$item: n, $model: t, $label: b.viewMapper(c, a)}), k(), s[0].focus()
